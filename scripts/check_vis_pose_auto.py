...
class CheckCostMapValue():
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.ready:
                ...
                pose_array.poses = self.pose_set
    ...
    def status_callback(self, status_msg):
        ...
        if driving_status == "navigating" and self.ready == False:
            self.pose_set = []
            self.ready = True
        
        if driving_status == "near_goal" or driving_status == "reach_goal":
            self.ready = False
